    ...
    paging: function(option) {
        ...
        function makePage(start,isHome,isEnd) {  //生成页码
			...
			*/
			...
			html += ' <div class="paging_r"><i>每页显示：<\/i><a href="javascript:void(0)" id="rePage20" style="margin-left:5px;" id="rePage20" >20<\/a><a href="javascript:void(0)"  id="rePage50">50<\/a><a href="javascript:void(0)"  id="rePage100">100<\/a><a href="javascript:void(0)"  id="rePage200">200<\/a><\/div>';
            obj.html(html);
        ...
        obj.find(".page").click(function(){
            ...
            light(_this);
            sendAjax(showPage,pageSizeAjax);
        ...
        obj.find("#next").click(function(){
            ...
            sendAjax(nextPage,pageSizeAjax);
        });
        ...
        obj.find("#end").click(function(){
           ...
           // light(obj.find("a").eq(pageSize+1));
            sendAjax(totalPage,pageSizeAjax);
        });
