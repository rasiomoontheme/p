    ...
    MultiTabs.prototype = {
        ...
        _listen: function () {
            ...
            handler($el.nav, 'contextmenu', '.mt-nav-tab', function (event) {
                ...
                var menuData = [
                  {text: $.utils.getLangs('menu_refersh'), onclick: function(){
                ...
                if (param.type !== 'main') {
                    menuData.push(
                        {text: $.utils.getLangs('menu_close'), onclick: function(){
                            self.close($navTab);
                            menu.hide();
                            return false;
                        }}
                ...
                menuData.push(
                    {text: $.utils.getLangs('menu_close_other'), onclick: function(){
    ...
    $.fn.multitabs.defaults = {
        ...
        language: { //language setting
            nav: {
                ...
                showActivedTab: $.utils.getLangs('show_active_tab'), //show active tab
                closeAllTabs: $.utils.getLangs('close_all_tabs'), //close all tabs
                closeOtherTabs: $.utils.getLangs('close_other_tabs'), //close other tabs
            }
        }
    };
})(jQuery));