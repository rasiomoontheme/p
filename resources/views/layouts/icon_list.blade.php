...
<input type='text' id="icon_field" value="" hidden="hidden">
...
<div class="example-icons">
    ...
    <div><i
            class="mdi mdi-arrow-down-bold-box-outline"></i><code>f72f</code><span>mdi-arrow-down-bold-box-outline</span>
    </div>
    ...
    <div><i
            class="mdi mdi-arrow-left-bold-box-outline"></i><code>f732</code><span>mdi-arrow-left-bold-box-outline</span>
    </div>
    ...
    <div><i
            class="mdi mdi-arrow-right-bold-box-outline"></i><code>f735</code><span>mdi-arrow-right-bold-box-outline</span>
    </div>
    ...
    <div><i class="mdi mdi-arrow-up-bold-box-outline"></i><code>f738</code><span>mdi-arrow-up-bold-box-outline</span>
    </div>
    ...
    <div><i
            class="mdi mdi-xbox-controller-battery-alert"></i><code>f74a</code><span>mdi-xbox-controller-battery-alert</span>
    </div>
    <div><i
            class="mdi mdi-xbox-controller-battery-empty"></i><code>f74b</code><span>mdi-xbox-controller-battery-empty</span>
    </div>
    <div><i
            class="mdi mdi-xbox-controller-battery-full"></i><code>f74c</code><span>mdi-xbox-controller-battery-full</span>
    </div>
    <div><i
            class="mdi mdi-xbox-controller-battery-low"></i><code>f74d</code><span>mdi-xbox-controller-battery-low</span>
    </div>
    <div><i
            class="mdi mdi-xbox-controller-battery-medium"></i><code>f74e</code><span>mdi-xbox-controller-battery-medium</span>
    </div>
    <div><i
            class="mdi mdi-xbox-controller-battery-unknown"></i><code>f74f</code><span>mdi-xbox-controller-battery-unknown</span>
    </div>
...
<script>
    $(".example-icons").on("click", "div", function () {
        var str = $(this).find("span").text();
        // 获取iframe id
        var iframe_id = $("#icon_field").val();
        //$("#"+iframe_id).contents().find('input[data-operate="select-icon"]').val($.trim(str));
        var sibling = $.utils.getSiblingFrame(iframe_id);
        sibling.$('input[data-operate="select-icon"]').val("mdi " + $.trim(str));
