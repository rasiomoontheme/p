...
@section('title', trans('res.agent_page.title.money_log'))

@section('content')
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h4>{{ trans('res.agent_page.title.money_log') }}</h4>
                ...
                <form action="" method="get" id="searchForm" name="searchForm">
                    <div class="row">
                        ...
                        'list' => [
                            ...
                            'number_type' => ['name' => trans('res.agent_page.field.add_sub'),'type' => 'select','data' => trans('res.option.money_number_type')],
                            ...
                            'money_type' => ['name' => trans('res.agent_page.field.fs_center'),'type' => 'select','data' => trans('res.option.member_money_type')],
                        ...
                        <div class="col-lg-2 col-sm-2">
                            <div class="input-group">
                                <button type="submit" class="btn btn-primary">
                                    <i class="mdi mdi-magni fy"></i>@lang('res.btn.search')</button>&nbsp;
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            @include('layouts._table_header',['data' => \App\Models\MemberMoneyLog::$list_field])
