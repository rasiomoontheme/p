...
@section('title', trans('res.agent_page.title.recharge_list'))

@section('content')
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h4>{{ trans('res.agent_page.title.recharge_list') }}</h4>
                    ...
                    <table class="table table-bordered">
                        ...
                        @foreach ($data as $item)
                            <tr>
                                ...
                                @include('layouts._table_body',['data' => \App\Models\Recharge::$list_field,'item' => $item])
