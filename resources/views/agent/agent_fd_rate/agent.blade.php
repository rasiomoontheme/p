...
@section('title', trans('res.agent_page.desc.agent_default_rate'))
    ...
    <div class="col-sm-12">
        ...
        <div class="card">
            ...
            <div class="card-header">
                <h4>{{ trans('res.agent_page.desc.agent_default_rate') }}</h4>
            ...
            <div class="card-body">
                <form action="{{ route('agent.memberoffline.fd') }}" method="post"
                      id="searchForm" name="searchForm">
                    <table class="table table-bordered table-hover text-center">
                        <tr>
                            <th class="text-center" style="width: 20%">@lang('res.common.game_type')</th>
                            <th class="text-center" style="width: 40%">@lang('res.agent_fd_rate.field.rate')</th>
