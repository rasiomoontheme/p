...
<head>
    <meta charset="UTF-8">
    <title>{{ systemconfig('site_title') ?? 'motoo' }}</title>
    ...
    <style>
        ...
        .tipsright_show {
            margin-left: 415px;
            background: url('{{ asset('/web/images/tipsRight.png') }}') no-repeat center top;
            height: 556px;
            text-align: center;
        }
...
<body>
    <div class="maintain">
        ...
        <div class="tipsright_show">
            <h1>{{ systemconfig('system_maintenance_message') ?? '网站维护中' }}</h1>
            <div class="dot">...</div>
            {{--<p>可能原因：</p>--}}
            {{--<p>网络信号弱</p>--}}
            {{--<p>找不到请求页面</p>--}}
