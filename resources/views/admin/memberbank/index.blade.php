                ...
                <form action="" method="get" id="searchForm" name="searchForm">
                    <div class="row">
                        ...
                        'list' => [
                                ...
                                'bank_type' => ['name' => trans('res.member_bank.field.bank_type'),'type' => 'select','data' => \App\Models\Bank::getAllBankArray()]
                            ]
                        ])
        ...
        <div class="card">
            <div class="card-toolbar clearfix">
                {{-- <div class="toolbar-btn-action">
                    <a class="btn btn-danger" id="batchDelete" data-operate="delete" data-url="/admin/memberbanks/ids">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            @include('layouts._table_header',['data' => \App\Models\MemberBank::$list_field,'model' => 'member_bank'])
                        ...
                        @foreach ($data as $item)
                            <tr>
                                ...
                                @include('layouts._table_body',['data' => \App\Models\MemberBank::$list_field,'item' =>
                                $item])
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <a class="btn btn-xs btn-default"
                                           href="{{ route('admin.memberbanks.edit',['memberbank' => $item->id]) }}" title=""
                                        ...
                                        <a class="btn btn-xs btn-default" href="javascript:;" data-operate="show-page"
                                           ...
                                           data-url="{{ route('admin.memberbanks.show', ['memberbank' => $item->id,'model' => 'memberbank']) }}">
                                        ...
                                        <a class="btn btn-xs btn-default" href="javascript:;" data-operate="delete"
                                           ...
                                           data-url="{{ route('admin.memberbanks.destroy', ['memberbank' => $item->id]) }}">
