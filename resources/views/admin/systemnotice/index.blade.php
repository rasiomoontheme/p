        ...
        <div class="card">
            <div class="card-header">
                @if(!isApp())
                    <h4>{{ $_title }}</h4>
                @else
                    <h4>@lang('res.system_notice.index.app_title')</h4>
                @endif
        ...
        <div class="card">
            <div class="card-toolbar clearfix">
                <div class="toolbar-btn-action">
                    <a class="btn btn-primary m-r-5" href="{{ route("admin.systemnotices.create",['is_app' => isApp()]) }}"><i
                                class="mdi mdi-plus"></i>
                        @lang('res.btn.add')</a>
                    {{-- <a class="btn btn-success m-r-5" href="#!"><i class="mdi mdi-check"></i> 启用</a>
                    <a class="btn btn-warning m-r-5" href="#!"><i class="mdi mdi-block-helper"></i> 禁用</a> --}}
                    <a class="btn btn-danger" id="batchDelete" data-operate="delete" data-url="/admin/systemnotices/ids">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            @include('layouts._table_header',['data' => \App\Models\SystemNotice::$list_field,'model' => 'system_notice'])
                        ...
                        @foreach ($data as $item)
                            <tr>
                                ...
                                @include('layouts._table_body',['data' => \App\Models\SystemNotice::$list_field,'item' => $item])
                                <td>{{ $item->updated_at }}</td>
                                {{--<td>{{ $item->created_at }}</td>--}}
                                <td>
                                    <div class="btn-group">
                                        <a class="btn btn-xs btn-default"
                                           href="{{ route('admin.systemnotices.edit',['systemnotice' => $item->id,'is_app' => isApp()]) }}" title=""
                                        ...
                                        {{-- <a class="btn btn-xs btn-default" href="javascript:;" data-operate="show-page"
                                            ...
                                            data-url="{{ route('admin.systemnotices.show', ['systemNotice' => $item->id]) }}">
                                        ...
                                        <a class="btn btn-xs btn-default" href="javascript:;" data-operate="delete"
                                           ...
                                           data-url="{{ route('admin.systemnotices.destroy', ['systemnotice' => $item->id]) }}">
