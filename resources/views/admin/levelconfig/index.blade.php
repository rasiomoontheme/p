        ...
        <div class="card">
            <div class="card-toolbar clearfix">
                <div class="toolbar-btn-action">
                    <a class="btn btn-primary m-r-5" href="{{ route("admin.levelconfigs.create") }}"><i
                                class="mdi mdi-plus"></i>
                        @lang('res.btn.add')</a>
                    {{-- <a class="btn btn-success m-r-5" href="#!"><i class="mdi mdi-check"></i> 启用</a>
                    <a class="btn btn-warning m-r-5" href="#!"><i class="mdi mdi-block-helper"></i> 禁用</a> --}}
                    <a class="btn btn-danger" id="batchDelete" data-operate="delete" data-url="/admin/levelconfigs/ids">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <th>ID</th>
                            @include('layouts._table_header',['data' => \App\Models\LevelConfig::$list_field,'model' => 'level_config'])
                        ...
                        @foreach ($data as $item)
                            <tr>
                                ...
                                <td>{{ $item->id }}</td>
                                @include('layouts._table_body',['data' => \App\Models\LevelConfig::$list_field,'item' => $item])
                                <td>{{ $item->updated_at }}</td>
                                <td>{{ $item->created_at }}</td>
                                <td>
                                    <div class="btn-group">
                                        <a class="btn btn-xs btn-default"
                                           href="{{ route('admin.levelconfigs.edit',['levelconfig' => $item->id]) }}" title=""
                                        ...
                                        {{-- <a class="btn btn-xs btn-default" href="javascript:;" data-operate="show-page"
                                            ...
                                            data-url="{{ route('admin.levelconfigs.show', ['levelconfig' => $item->id]) }}">
                                        ...
                                        <a class="btn btn-xs btn-default" href="javascript:;" data-operate="delete"
                                           ...
                                           data-url="{{ route('admin.levelconfigs.destroy', ['levelconfig' => $item->id]) }}">
