                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            @include('layouts._table_header',['data' => \App\Models\DailyBonus::$list_field,'model' => 'daily_bonus'])
                        ...
                        @foreach ($data as $item)
                            <tr>
                                ...
                                @include('layouts._table_body',['data' => \App\Models\DailyBonus::$list_field,'item' => $item])
                                <td>{{ $item->updated_at }}</td>
                                <td>{{ $item->created_at }}</td>
                                <td>
                                    <div class="btn-group">
                                        <a class="btn btn-xs btn-default"
                                           href="{{ route('admin.dailybonuses.edit',['dailybonus' => $item->id]) }}" title=""
                                        ...
                                        <a class="btn btn-xs btn-default" href="javascript:;" data-operate="delete"
                                           ...
                                           data-url="{{ route('admin.dailybonuses.destroy', ['dailybonus' => $item->id]) }}">
