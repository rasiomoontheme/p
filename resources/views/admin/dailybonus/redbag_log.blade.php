                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                @php
                                    $header_data = \App\Models\MemberMoneyLog::$list_field;
                                    unset($header_data['user_id']);
                                @endphp
                                @include('layouts._table_header',['data' => $header_data,'model' => 'member_money_log'])
                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    @include('layouts._table_body',['data' => $header_data,'item' => $item])
