            ...
            <div class="card-body collapse in" id="searchContent" aria-expanded="true">
                <form action="" method="get" id="searchForm" name="searchForm">
                    <div class="row">
                        ...
                        [
                        'list' => [
                            'name' => ['name' => trans('res.game_hot.field.name'),'type' => 'text'],
                            //'lang' => ['name' => trans('res.game_hot.field.lang'),'type' => 'select', 'data' => config('platform.language_type')],
                            'type' => ['name' => trans('res.game_hot.field.type'),'type' => 'select', 'data' => trans('res.game_hot.hot_game_place_type')],
                        ]
                        ])
        ...
        <div class="card">
            <div class="card-toolbar clearfix">
                <div class="toolbar-btn-action">
                    <a class="btn btn-primary m-r-5" href="{{ route("admin.gamehots.create") }}"><i
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            @include('layouts._table_header',['data' => \App\Models\GameHot::$list_field,'model' => 'game_hot'])
                        ...
                        @foreach ($data as $item)
                            <tr>
                                ...
                                @include('layouts._table_body',['data' => \App\Models\GameHot::$list_field,'item' => $item])
                                <td>{{ $item->created_at }}</td>
                                <td>
                                    <div class="btn-group">
                                        <a class="btn btn-xs btn-default" href="javascript:;"
                                           data-url="{{ route('admin.gamehots.edit',['gamehot' => $item->id]) }}" title=""
                                        ...
                                        <a class="btn btn-xs btn-default" href="javascript:;" data-operate="show-page"
                                           ...
                                           data-url="{{ route('admin.gamehots.show', ['gamehot' => $item->id]) }}">
                                        ...
                                        <a class="btn btn-xs btn-default" href="javascript:;" data-operate="delete"
                                           ...
                                           data-url="{{ route('admin.gamehots.destroy', ['gamehot' => $item->id]) }}">
