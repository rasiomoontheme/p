...
class CreatePermissionTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create($tableNames['permissions'], function (Blueprint $table) {
            ...
            $table->string('name')->comment("菜单名称")->unique();
            $table->string('lang_json')->default('')->comment('多语言');
            $table->string('icon')->nullable()->default("mdi")->comment("菜单图标");
            ...
            $table->unsignedInteger('weight')->default(1)->comment('权重，越大越靠前');
